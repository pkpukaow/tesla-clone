...
const HeroContent: FC<HeroContentType> = ({ bgImage, title, subTitle, link, color, buttonList }) => {
    return (
        <div
            style={{
            ...
            <div className={`flex flex-col sm:flex-row justify-center gap-3 px-4 w-full ${"text-" + color}`}>
